...
> **Prerequisites**: Read [Start Here](/start-here), [System Overview](/system-overview), and [Master Agents](/agents-master) first.
...
- **[Master Agents](/agents-master)**: Master agents that route to these teams
- **[Specialized Agents](/agents-specialized)**: 48 MCP agents that generate insights
- **[System Overview](/system-overview)**: Complete system architecture
- **[MCP Integration](/mcp-integration)**: MCP tools used by Schema agents
- **[Database Schema](/database-schema)**: Database structure for recommendations
